...
assign("color_map_global",
       c("NS" = scico::scico(palette = "batlow", direction = 1, n = 23)[19],
         "LR" = scico::scico(palette = "batlow", direction = 1, n = 23)[15],
         "halfNS" = scico::scico(palette = "batlow", direction = 1, n = 23)[17],
         "Water" = scico::scico(palette = "batlow", direction = 1, n = 23)[12],
         "D5halfNS" = scico::scico(palette = "batlow", direction = 1, n = 23)[4],
         "D5halfNSwK" = scico::scico(palette = "batlow", direction = 1, n = 23)[7],
         "hyperNS" = scico::scico(palette = "batlow", direction = 1, n = 23)[21],
         "D5NS" = scico::scico(palette = "batlow", direction = 1, n = 23)[5],
         "D5LR" = scico::scico(palette = "batlow", direction = 1, n = 23)[3],
         "D5W" = scico::scico(palette = "batlow", direction = 1, n = 23)[2]),
       envir = globalenv())
...
assign("lab_strings_bmp_no_gap", c("sodium", "chloride", "potassium_plas", "co2_totl", "bun",  "creatinine", "calcium", "glucose"), envir = globalenv())
...
assign("fluids", list(NS, D5NS, LR, D5LR, D5W, D5halfNSwK, D5halfNS, halfNS, SW), envir = globalenv())
assign("fluid_names", c("NS", "D5NS", "LR", "D5LR", "D5W", "D5halfNSwK", "D5halfNS", "halfNS", "Water"), envir = globalenv())
...
RCV_decrease <- list(sodium = 0.031, chloride = 0.055, potassium_plas = 0.099, co2_totl = 0.232, creatinine = 0.134, bun = 0.295, calcium = 0.059, glucose = 0.126)
